...
{
	vmm_printf("imx6_early_init\n");
	imx_print_silicon_rev(cpu_is_imx6dl() ? "i.MX6DL" : "i.MX6Q",
			      imx_get_soc_revision());//Com o early print isto não imprime
	vmm_printf("imx6_early_init 1\n");
	imx_soc_device_init();//Não interessa
	vmm_printf("imx6_early_init 2\n");
	imx6q_init_irq();
	vmm_printf("imx6_early_init 3\n");
	return 0;
}
