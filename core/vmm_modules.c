...
int __init vmm_modules_init(void)
{
	...
	modctrl.mod_count = 0;
	//vmm_printf("vmm_modules_init\n");
	ag_mod_list = aggregate_modules(arch_modtbl_vaddr(), 
					arch_modtbl_size());
	//vmm_printf("vmm_modules_init1\n");
